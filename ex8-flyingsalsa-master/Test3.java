...
/**
 * Test 6 for CS2030S Lab 7 (AY21/22 Sem 2).  Tests
...
class Test6 {
  ...
  public static void main(String[] args) {
    ...
    i.expectReturn(
        "InfiniteList.sentinel().reduce(0, (x, y) -> x + y)",
        () -> InfiniteList.<Integer>sentinel().reduce(0, (x, y) -> x + y), 0);
    i.expectReturn(
    ...
    i.expectReturn(
        "InfiniteList.sentinel().count()",
        () -> InfiniteList.sentinel().count(), 0L);
    i.expectReturn(
...
System.out.println(numbers.takeWhile(x -> x < 2)
