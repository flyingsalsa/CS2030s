...
public abstract class Maybe<T> {
  ...
  private static final class Some<T> extends Maybe<T> {
    ...
    public <U> Maybe<U> flatMap(Transformer<? super T, ? extends Maybe<? extends U>> mapper) {
      ...
      // typecast is necessary as Generics are invariant, Maybe<Subclass of U> is 
      // not related to Maybe<U> but can be returned by the transformer
  ...
  public abstract <U> Object orElse(U o);
